...
export default function ChemicalCourse() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description:
        "The Java Full Stack Web course blends self-paced online learning with in-person sessions for hands-on practice. It enhances comprehension, fosters collaboration, and provides an engaging learning experience.",
    },
    {
      ...
      <main>
        ...
        <div className="relative h-[400px] bg-gradient-to-r from-[#2B6BE6] to-[#1C4ED8] overflow-hidden">
          <div className="absolute inset-0 flex items-start pt-12 justify-between px-8">
            ...
            <img
              src="/images/Java1.png" // Add hero image
              alt="Data Science"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                The Java Full Stack Web course covers both front-end and
                back-end development, equipping students with skills to build
                dynamic web applications. It includes Java fundamentals, Spring
                Boot framework, HTML, CSS, JavaScript, and front-end
                technologies like React. The course teaches how to create
                RESTful APIs, work with databases using JPA and Hibernate, and
                implement user authentication and security protocols. Students
                will learn about version control using Git, testing with JUnit,
                and deploying applications on cloud platforms. By the end,
                participants will have the skills to develop and deploy complete
                Java-based web applications from start to finish.
              </p>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <img
                src="/images/java2.png" // Add laboratory image
                alt="Laboratory Work"

        ...
        <div className="relative h-[400px] bg-gradient-to-r from-[#2B6BE6] to-[#1C4ED8] overflow-hidden">
          <div className="absolute inset-0 flex items-start pt-12 justify-between px-8">
            <div className="text-white">
              ...
              <h1 className="text-5xl font-bold mb-9 ml-8">Hotel Management</h1>
            ...
            <img
              src="/images/HotelManagement1.png" // Add hero image
              alt="Data Science"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                The "Hotel Management" program is a comprehensive course
                tailored for aspiring hospitality professionals. With the global
                tourism and hospitality industry witnessing significant growth,
                the demand for skilled managers is at an all-time high. This
                program aligns with industry needs and equips students with
                essential expertise in operations management, customer service,
                event planning, and culinary arts. The curriculum includes
                modules on hotel administration, food and beverage management,
                housekeeping, and hospitality marketing, ensuring students gain
                both theoretical knowledge and practical experience. By
                mastering these skills, learners will be prepared to excel in
                dynamic roles across hotels, resorts, and other hospitality
                sectors.
              </p>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <img
                src="/images/HotelManagement2.png" // Add laboratory image
                alt="Laboratory Work"

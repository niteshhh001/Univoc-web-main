...
export default function ChemicalCourse() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description:
        "The Full Stack MERN course provides flexible online and in-person learning, blending self-paced modules, live instructor sessions, and hands-on projects. This approach ensures personalized guidance, enhanced engagement, and a comprehensive understanding of full-stack development.",
    },
    {
      ...
      <main>
        ...
        <div className="relative h-[400px] bg-gradient-to-r from-[#2B6BE6] to-[#1C4ED8] overflow-hidden">
          <div className="absolute inset-0 flex items-start pt-12 justify-between px-8">
            ...
            <img
              src="/images/MERN1.png" // Add hero image
              alt="Data Science"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                The Full Stack MERN course offers a comprehensive learning
                experience in web development, covering the MongoDB, Express.js,
                React, and Node.js stack. Students will learn to build dynamic,
                scalable, and responsive web applications, mastering front-end
                development with React and back-end development using Node.js
                and Express. The course includes database management with
                MongoDB, API development, authentication, and integration of
                third-party services. Emphasis is placed on practical skills,
                with hands-on projects to reinforce learning. By the end of the
                course, students will be equipped to develop full-stack
                applications from scratch, ready for real-world challenges in
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <img
                src="/images/MERN2.png" // Add laboratory image
                alt="Laboratory Work"

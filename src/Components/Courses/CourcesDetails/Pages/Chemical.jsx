      ...
      <main>
        ...
        <div className="relative h-[400px] bg-gradient-to-r from-[#2B6BE6] to-[#1C4ED8] overflow-hidden">
          <div className="absolute inset-0 flex items-start pt-12 justify-between px-8">
            <div className="text-white">
              <nav className="mb-12">
                <ul className="flex gap-5 text-sm opacity-80">
                  ...
                  <li>›</li>
                  <li className="hover:opacity-100 cursor-pointer">Chemical</li>
                </ul>
              </nav>
              <h1 className="text-5xl font-bold mb-9 ml-8">CHEMICAL</h1>
            ...
            <img
              src="/images/Chemical1.png" // Add hero image
              alt="Data Science"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                ...
                chemistry, physics, and mathematics, applied to solve problems
                in the production of chemicals, materials, and energy. The
                program includes subjects like thermodynamics, fluid mechanics,
                reaction engineering, process control, and material science,
                offering both theoretical knowledge and practical skills.
                Students gain hands-on experience through laboratory work,
                project assignments, and industry internships. The course
                prepares graduates for diverse roles in industries such as
                pharmaceuticals, energy, food processing, and environmental
                management, equipping them with the expertise to innovate and
                optimize processes for sustainable development.
              </p>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <img
                src="/images/Chemical2.png" // Add laboratory image
                alt="Laboratory Work"

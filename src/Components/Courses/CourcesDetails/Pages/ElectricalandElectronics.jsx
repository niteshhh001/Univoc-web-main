...
export default function ChemicalCourse() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description:
        "Electrical and Electronics courses blend online learning with hands-on in-person classes for convenience and engagement. This approach personalizes learning, enhancing understanding and practical skills.",
    },
    {
      ...
      <main>
        ...
        <div className="relative h-[400px] bg-gradient-to-r from-[#2B6BE6] to-[#1C4ED8] overflow-hidden">
          <div className="absolute inset-0 flex items-start pt-12 justify-between px-8">
            ...
            <img
              src="/images/ELECTRICAL AND ELECTRONICS1.png" // Add hero image
              alt="Data Science"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                ...
                includes subjects like circuit analysis, electrical machines,
                power systems, signal processing, control systems, and
                electronics devices. Students learn to design and analyze
                electrical circuits, understand the operation of electrical
                machines and power generation, and delve into communication
                systems, microprocessors, and embedded systems. Practical
                applications such as renewable energy systems, electrical
                instrumentation, and automation technologies are also explored.
                The course prepares students for careers in industries like
                power generation, telecommunications, robotics, and electronics
                manufacturing, equipping them with both theoretical knowledge
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <img
                src="\images\ELECTRICAL AND ELECTRONICS2.png" // Add laboratory image
                alt="Laboratory Work"

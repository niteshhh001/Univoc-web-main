          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                ...
                program includes studies in thermodynamics, fluid mechanics,
                chemical engineering, process control, and material science,
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <img
                src="" // Add laboratory image
                alt="Laboratory Work"
                className="w-full h-[240px] object-cover rounded-xl mb-6"
              />
              <div className="space-y-4">

...
export default function ChemicalCourse() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description:
        "Mechanical engineering courses blend online learning with in-person instruction for flexibility and hands-on practice. This approach enhances learning efficiency and promotes better engagement with course content.",
    },
    {
  ...
  const relatedCourses = [
    {
      title: "Chemical",
      rating: 4.5,
      image: chemi, // Add image URL here
    },
    {
      title: "Hotel Management",
      rating: 4.5,
      image:hotel, // Add image URL here
    },
    {
      title: "Full Stack MEAN",
      rating: 4.5,
      image: mean, // Add image URL here
    },
  ];
      ...
      <main>
        ...
        <div className="relative h-[400px] bg-gradient-to-r from-[#2B6BE6] to-[#1C4ED8] overflow-hidden">
          <div className="absolute inset-0 flex items-start pt-12 justify-between px-8">
            ...
            <img
              src="/images/Mechanical1.png" // Add hero image
              alt="Data Science"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                The Mechanical Engineering course offers a comprehensive
                curriculum that covers the fundamentals of mechanics,
                thermodynamics, materials science, and fluid dynamics. Students
                learn to design, analyze, and manufacture mechanical systems
                using advanced technologies and tools. The program includes
                hands-on experience through laboratory work, projects, and
                internships, providing practical knowledge in areas such as
                robotics, automation, and energy systems. Courses in
                mathematics, physics, computer-aided design (CAD), and
                mechanical testing equip students with problem-solving skills
                essential for various industries. Graduates are prepared for
                roles in engineering design, manufacturing, research and
                development, and management within diverse sectors.
              </p>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <img
                src="/images/Dotnet2.png" // Add laboratory image
                alt="Laboratory Work"

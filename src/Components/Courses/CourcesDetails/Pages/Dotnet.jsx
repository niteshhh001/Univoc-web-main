...
export default function ChemicalCourse() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description:
        "The Dot Net Full Stack course blends online learning with in-person interaction, boosting student engagement. It enhances personalized learning, practical application, and supports diverse learning styles for better skill mastery.",
    },
    {
      ...
      <main>
        ...
        <div className="relative h-[400px] bg-gradient-to-r from-[#2B6BE6] to-[#1C4ED8] overflow-hidden">
          <div className="absolute inset-0 flex items-start pt-12 justify-between px-8">
            ...
            <img
              src="\public\images\Dotnet1.png" // Add hero image
              alt="Data Science"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                ...
                deployment techniques. The course also focuses on version
                control using Git, testing strategies, and debugging practices,
                ensuring students gain comprehensive knowledge for building and

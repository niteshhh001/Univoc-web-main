...
export default function ChemicalCourse() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description:
        "A data science course blends technical skills like programming and statistical analysis with practical knowledge in machine learning and visualization. It enhances career opportunities and empowers data-driven decision-making across industries.",
    },
    {
  ...
  const relatedCourses = [
    ...
    {
      title: "Mechalnical Engineer",
      rating: 4.5,
      image: mecha, // Add image URL here
    },
  ];
        ...
        <div className="relative h-[400px] bg-gradient-to-r from-[#2B6BE6] to-[#1C4ED8] overflow-hidden">
          <div className="absolute inset-0 flex items-start pt-12 justify-between px-8">
            <div className="text-white">
              ...
              <h1 className="text-5xl font-bold mb-9 ml-8">DATA SCIENCE</h1>
            ...
            <img
              src="/images/DataScience1.png" // Add hero image
              alt="Data Science"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                ...
                individuals eager to pursue a career in the rapidly growing
                field of data analysis. As industries increasingly rely on data
                to drive decision-making, the need for skilled data scientists
                is on the rise. This program covers essential areas such as data
                mining, machine learning, statistical analysis, and data
                visualization. Students will engage in hands-on projects and
                learn to work with tools like Python, R, and SQL. By combining
                theoretical foundations with practical skills, graduates will be
                well-prepared to excel in diverse roles within data-driven
                sectors like technology, finance, and healthcare
              </p>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <img
                src="/images/DataScience2.png" // Add laboratory image
                alt="Laboratory Work"
